...
const CountdownTimer = ({ accessGranted, setAccessGranted }) => {
    ...
    const [timer, setTimer] = useState("01:00:10");
    ...
    // This is listening to the timer and reseting it when it runs out
    useEffect(() => {
        if (timer === '00:00:00') {
